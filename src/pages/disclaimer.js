    ...
    <PageLayout>
      ...
      <ul>
        <li>
          ...
          this Disclaimer) refers to CodeProjects.
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: info@code-projects.de</p>
        </li>
        <li>
          <p>By phone number: +491792103330</p>
        </li>
        <li>
          <p>
            By mail: Sabine Schoetensack, Gladbacher Straße 166, 50189 Elsdorf
          </p>
        </li>
      </ul>
    </PageLayout>
